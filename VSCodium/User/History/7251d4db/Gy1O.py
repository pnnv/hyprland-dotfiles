...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_type', default='power', choices=['custom', 'power', 'rsi_elements', 'learning_rate', 'decay'],
    ...
    parser.add_argument("--num_time_steps_per_eps", default=100, type=int, metavar='N', help='Maximum number of steps per episode (default: 20000)')
    # parser.add_argument("--num_eps", default=10, type=int, metavar='N', help='Maximum number of episodes (default: 5000)')
    parser.add_argument("--num_eps", default=1, type=int, metavar='N', help='Maximum number of episodes (default: 5000)')
    ...
    parser.add_argument("--decay", default=1e-1, type=float, metavar='G', help='Decay rate for the networks (default: 0.00001)')
